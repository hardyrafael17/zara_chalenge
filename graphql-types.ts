...
export type Unnamed_1_Query = { locales: { edges: Array<{ node: { ns?: string | null, data?: string | null, language?: string | null } }> }, someOtherData: { edges: Array<{ node: { relativePath: string, prettySize: string, extension: string, birthTime: any } }> } };
