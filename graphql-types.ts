...
export type Unnamed_1_Query = { locales: { edges: Array<{ node: { ns?: string | null, data?: string | null, language?: string | null } }> }, allFile: { edges: Array<{ node: { id: string, relativeDirectory: string, absolutePath: string, childImageSharp?: { gatsbyImageData: any } | null } }> } };
