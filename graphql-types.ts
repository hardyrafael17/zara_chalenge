...
export type Unnamed_1_Query = { locales: { edges: Array<{ node: { ns?: string | null, data?: string | null, language?: string | null } }> }, allFile: { edges: Array<{ node: { id: string, name: string, relativePath: string, childImageSharp?: { gatsbyImageData: any, internal: { content?: string | null, description?: string | null, ignoreType?: boolean | null, mediaType?: string | null, contentFilePath?: string | null } } | null } }> } };
...
export type Unnamed_2_Query = { locales: { edges: Array<{ node: { ns?: string | null, data?: string | null, language?: string | null } }> } };
